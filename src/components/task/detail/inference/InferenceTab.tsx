  ...
  return (
    <div className="flex flex-col w-full gap-4">
      <div className="w-full grid grid-cols-2 gap-4">
        ...
        <div className="flex flex-col w-full gap-2">
          <span className="text-sm text-gray-500">출력 예시</span>
          <div className="rounded border border-gray-200 p-4">출력 예시</div>
        </div>
      </div>
      <div className="flex flex-col w-full gap-2">
      ...
      <div className="flex flex-col w-full gap-2">
        ...
        <div className="rounded border border-gray-200 p-4">출력</div>
      </div>
